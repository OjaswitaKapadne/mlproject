...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            categorical_columns = ["gender", "race_ethnicity", "parental_level_of_education", "lunch", "test_preparation_score"]
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info("Read train and tesst completed!!")
            ...
            logging.info("Applying the preprocessor object on training and testing dataframe")
